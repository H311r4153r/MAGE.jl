# SA-EDA on PSB2 square-digits — auto-generated from mage-mcts-binary/problems/mcts-square-digits.jl
...
# ---- PROBLEM-SPECIFIC BLOCK (lifted from mcts-square-digits.jl) ----
# PARAMS --- --- 
N_TRAIN = 200
N_TEST = 2000
PROBLEM = "square-digits"
EXPERIMENT_NAME = "SQUARE DIGITS"
STAGE = 1
MODE = "MCTS"
N_types = 3
...
# ---- ARCHITECTURE (lifted from mcts-square-digits.jl) ----
### Model Architecture ###
model_arch = modelArchitecture(
    [Int, String, Int, Int, Int],
    [4, 1, 4, 4, 4],
    [String, Vector{String}, Vector{Int}],
    [String],
    [1]
)
