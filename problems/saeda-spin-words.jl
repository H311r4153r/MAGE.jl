# SA-EDA on PSB2 spin-words — auto-generated from mage-mcts-binary/problems/mcts-spin-words.jl
...
# ---- PROBLEM-SPECIFIC BLOCK (lifted from mcts-spin-words.jl) ----
# PARAMS --- --- 
N_TRAIN = 200
N_TEST = 2000
PROBLEM = "spin-words"
EXPERIMENT_NAME = "SPIN WORDS"
STAGE = 1
MODE = "MCTS"
N_types = 3
...
# ---- ARCHITECTURE (lifted from mcts-spin-words.jl) ----
### Model Architecture ###
