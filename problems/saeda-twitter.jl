# SA-EDA on PSB2 twitter — auto-generated from mage-mcts-binary/problems/mcts-twitter.jl
...
# ---- PROBLEM-SPECIFIC BLOCK (lifted from mcts-twitter.jl) ----
# PARAMS --- --- 
N_TRAIN = 200
N_TEST = 2000
PROBLEM = "twitter"
...
extra_inputs = [1, 140, "", "Your tweet has", "characters", "Too many characters", "You didn't type anything"]
# TRAIN DATA --- ---- 
X, Y = make_rows(
    ["input1"],
    [string_caster],
...
# ---- ARCHITECTURE (lifted from mcts-twitter.jl) ----
### Model Architecture ###
